...
class ExperimentRunner:
    ...
    def __init__(self, output_base_dir: str = "Minibus_ratio_results"):
        ...
        self.minibus_capacity_values = [6]  # Changed from [6, 8]
        self.minibus_ratio_values =  [0.03]  # Changed from [0.1, 0.2, 0.3]
        self.optimization_interval_values = [60, 120, 300]  # Optimization interval in seconds (1min, 2min, 5min, 10min)
