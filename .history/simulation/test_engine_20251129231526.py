...
def create_minimal_test_data():
    ...
    stations = {
        "stations": [
            {"station_id": "A", "name": "Station A", "lat": 0.0, "lon": 0.0},
            {"station_id": "B", "name": "Station B", "lat": 0.1, "lon": 0.1},
            {"station_id": "C", "name": "Station C", "lat": 0.2, "lon": 0.2},
            {"station_id": "D", "name": "Station D", "lat": 0.3, "lon": 0.3},
            {"station_id": "E", "name": "Station E", "lat": 0.4, "lon": 0.4}
        ]
    }
    
    with open("mockdata/stations.json", "w") as f:
        json.dump(stations, f, indent=2)
    logger.info("✓ Created stations.json")
    ...
    np.save("mockdata/travel_time_matrix.npy", travel_times)
    logger.info("✓ Created travel_time_matrix.npy")
    ...
    with open("mockdata/matrix_metadata.json", "w") as f:
        json.dump(metadata, f, indent=2)
    logger.info("✓ Created matrix_metadata.json")
    ...
    with open("mockdata/bus_schedule.csv", "w") as f:
        f.write("\n".join(schedule_data))
    logger.info("✓ Created bus_schedule.csv")
...
if __name__ == "__main__":
    ...
    data_files = [
        "mockdata/stations.json",
        "mockdata/travel_time_matrix.npy",
        "mockdata/matrix_metadata.json",
        "mockdata/bus_schedule.csv"
    ]
