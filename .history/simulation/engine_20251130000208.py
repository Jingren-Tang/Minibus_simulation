...
class SimulationEngine:
    ...
    def _add_test_passengers(self) -> None:
        ...
        Creates test passengers that appear BEFORE buses arrive to ensure they can board.
        """
        test_passengers_data = [
            # Passengers appear early so they can catch the first buses
            {"id": "P1", "origin": "A", "dest": "C", "appear_time": 0.0},      # At A before BUS_1 arrives
            {"id": "P2", "origin": "A", "dest": "D", "appear_time": 0.0},      # At A before BUS_1 arrives
            {"id": "P3", "origin": "B", "dest": "D", "appear_time": 150.0},    # At B before BUS_1 arrives (08:02:30)
            {"id": "P4", "origin": "E", "dest": "C", "appear_time": 250.0},    # At E before BUS_2 arrives (08:04:10)
            {"id": "P5", "origin": "A", "dest": "E", "appear_time": 580.0},    # At A before BUS_3 arrives (08:09:40)
            {"id": "P6", "origin": "C", "dest": "E", "appear_time": 590.0},    # At C (08:09:50)
            {"id": "P7", "origin": "E", "dest": "B", "appear_time": 250.0},    # At E before BUS_2 arrives
        ]
    ...
    def finalize(self) -> None:
        ...
        for bus_id, bus in self.buses.items():
            logger.info(
                ...
                f"current occupancy: {len(bus.passengers)}/{bus.capacity}"  # Changed here
            )
