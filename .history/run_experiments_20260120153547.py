...
class ExperimentRunner:
    ...
    def __init__(self, output_base_dir: str = "Minibus_ratio_results_5"):
        ...
        self.minibus_capacity_values = [8]  # Changed from [6, 8]
        self.minibus_ratio_values =  [0.3]  # Changed from [0.1, 0.2, 0.3]
        self.optimization_interval_values = [5, 30, 60, 300, 600]  # Optimization interval in seconds (1min, 2min, 5min, 10min)
    ...
    def extract_metrics_from_csv(self, result_dir: str) -> Dict:
        ...
        try:
            ...
            if 'vehicle_type' not in passengers_df.columns:
                ...
                # Try to infer vehicle_type from vehicles.csv if vehicle_id exists
