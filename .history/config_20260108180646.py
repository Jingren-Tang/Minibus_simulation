...
SIMULATION_END_TIME = "15:30:00"  # MODIFIED: Extended to 21:00 for full 6-hour simulation
...
PASSENGER_ALLOCATION_STRATEGY = "schedule"  # "fixed" or "schedule"
...
MINIBUS_PASSENGER_RATIO = 0.3

# NEW: Schedule-based mode - Used when PASSENGER_ALLOCATION_STRATEGY = "schedule"
...
MINIBUS_PASSENGER_RATIO_SCHEDULE = [
    ...
    {"start_time": "17:00:00", "end_time": "19:00:00", "ratio": 0.5},
    {"start_time": "19:00:00", "end_time": "21:00:00", "ratio": 0.25}
]
...
def get_schedule_based_config() -> Dict[str, Any]:
    ...
    PASSENGER_ALLOCATION_STRATEGY = "schedule"
    return get_config()
