...
class Bus:
    ...
    def arrive_at_station(
            ...
            # MODIFIED: Filter passengers by service mode
            waiting_passengers = station.get_waiting_passengers()
            
            for passenger in waiting_passengers:
                # NEW: Check if passenger has appeared and is assigned to bus service
