...
def test_minibus():
    ...
    station_b.add_passenger(p1)
    station_b.add_passenger(p2)
    station_c.add_passenger(p3)
    ...
    station_b.add_passenger(p4)
    station_b.add_passenger(p5)
    station_b.add_passenger(p6)
