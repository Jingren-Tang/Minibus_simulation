...
class ExperimentRunner:
    ...
    def __init__(self, output_base_dir: str = "Minibus_ratio_results"):
        ...
        self.num_minibuses_values = [1, 2, 3]
        self.minibus_capacity_values = [4, 6, 8]
        self.minibus_ratio_values = [0.1, 0.2, 0.3, 0.4]
            ...
            for capacity in self.minibus_capacity_values:
                for ratio in self.minibus_ratio_values:
                    exp_config = {
                        ...
                        'minibus_ratio': ratio,
                        'exp_name': f"exp_{exp_id:03d}_n{num_minibuses}_c{capacity}_r{ratio}",
                        'output_dir': str(self.output_base_dir / f"exp_{exp_id:03d}_n{num_minibuses}_c{capacity}_r{ratio}")
                    }
    ...
    def modify_config(self, exp_config: Dict) -> None:
        ...
        try:
            ...
            content = re.sub(
                ...
                f'NUM_MINIBUSES = {exp_config["num_minibuses"]}',
                content
            )
            ...
            content = re.sub(
                r'OUTPUT_DIR\s*=\s*["\'].*?["\']',
                f'OUTPUT_DIR = "{exp_config["output_dir"]}"',
                content
            )
            ...
            logger.info(f"Config modified: n={exp_config['num_minibuses']}, "
    ...
    def extract_metrics_from_csv(self, result_dir: str) -> Dict:
        ...
        try:
            ...
            # Wait time statistics (including abandoned passengers)
            ...
            metrics['avg_travel_time'] = float(valid_travel_times.mean()) if len(valid_travel_times) > 0 else 0.0
    ...
    def save_summary(self, results: List[Dict]) -> None:
        ...
        try:
            ...
            column_order = [
                ...
                'avg_travel_time', 'total_passengers_served',
