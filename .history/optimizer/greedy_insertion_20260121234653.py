...
This fixes the "横跳" (zigzag) problem where minibuses visit the same station multiple times.
"""
...
def _try_insert_passenger_smart(
    ...
    """
    ✅ FIXED VERSION: Smart insertion that reuses existing stations when possible.
