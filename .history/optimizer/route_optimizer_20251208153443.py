...
class RouteOptimizer:
    ...
    def _prepare_input(
        ...
        that can be passed to any optimizer type.
        ...
        # 2. Minibus states are already in dict format from get_minibus_info()
        # We only need to extract the relevant fields for the optimizer
        minibus_list = []
