...
class RouteOptimizer:
    ...
    def _prepare_input(
        ...
        max_travel_time_ratio = self.config.get('max_travel_time_ratio', 1.5)  # Default: 1.5x direct time
        ...
        input_data = {
            ...
            "max_travel_time_ratio": max_travel_time_ratio  # NEW: Travel time ratio constraint
        }
