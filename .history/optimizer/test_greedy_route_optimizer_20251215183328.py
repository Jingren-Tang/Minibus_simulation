"""
test_greedy_optimizer.py

Comprehensive test suite for RouteOptimizer with greedy_insertion module.
Tests various scenarios to validate the integration and algorithm behavior.
"""
