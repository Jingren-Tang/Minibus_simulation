...
class ExperimentRunner:
    ...
    def __init__(self, output_base_dir: str = "Minibus_ratio_results"):
        ...
        self.minibus_ratio_values =  [0.01, 0.05]  # Changed from [0.1, 0.2, 0.3]
        self.optimization_interval_values = [60, 300]  # Optimization interval in seconds (1min, 2min, 5min, 10min)
