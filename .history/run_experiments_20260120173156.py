...
class ExperimentRunner:
    ...
    def __init__(self, output_base_dir: str = "Minibus_ratio_results_5"):
        ...
        self.minibus_ratio_values =  [0.1,0.25,0.4]  # Changed from [0.1, 0.2, 0.3]
        self.optimization_interval_values = [5, 30, 60, 300, 450]  # Optimization interval in seconds (1min, 2min, 5min, 10min)
