...
def main():
    ...
    base_date = datetime(2025, 12, 18)  # Thursday, December 18, 2025
    print(f"\n3. Generating time points (base date: {base_date.strftime('%Y-%m-%d %A')})...")
    time_points = generate_time_points(base_date, start_hour=17, end_hour=19)
    print(f"   Generated {len(time_points)} time points from 17:00 to 19:00")
