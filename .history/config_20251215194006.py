...
MATRIX_METADATA_FILE, BUS_SCHEDULE_FILE(mockdata or data)
ENABLE_MINIBUS, MINIBUS_INITIAL_LOCATIONS, OD_MATRIX_FILE, OD_METADATA_FILE,
...
MINIBUS_INITIAL_LOCATIONS = ['A','B','C']  # Can also be "random"
...
def validate_config() -> bool:
    ...
    # Check if required mockdata files exist
    required_files = [
        STATIONS_FILE,
