...
MINIBUS_INITIAL_LOCATIONS = ["A", "C", "E"]
...
def get_config() -> Dict[str, Any]:
    ...
    config = {
        ...
        # Data file paths (注意这里的键名要匹配 SimulationEngine 期望的)
        "stations_file": STATIONS_FILE,
        "travel_time_matrix": TRAVEL_TIME_MATRIX_FILE,  # 改这里
        "matrix_metadata": MATRIX_METADATA_FILE,        # 改这里
        "bus_schedule": BUS_SCHEDULE_FILE,              # 改这里
...
def validate_config() -> bool:
    ...
    # Validate number of minibuses matches initial locations
