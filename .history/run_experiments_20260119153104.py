...
class ExperimentRunner:
    ...
    def __init__(self, output_base_dir: str = "Minibus_ratio_results_5"):
        ...
        self.minibus_ratio_values =  [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5]  # Changed from [0.1, 0.2, 0.3]
        self.optimize_interval_values = [300]  # Optimize interval in seconds (1min, 2min, 5min, 10min)
